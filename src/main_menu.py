...
def main_menu(mode):
    ...
    line_graph = styles.BlueButton(foreground.foreground,"Line Graph",command=lambda: graphs.line_graph(mode),sizex=650,sizey=250)
    ...
    currency_conv = styles.BlueButton(foreground.foreground,"Currency Conversion",command=lambda: currencies.convert(mode),sizex=650,sizey=250)
